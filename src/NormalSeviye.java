...
public class NormalSeviye implements ActionListener{ 
    ...
    int süre =0;
    JButton[][] buton = new JButton[16][16];
    int[][] sayım = new int[16][16];
    ...
    public NormalSeviye() {
       ...
       reset.setPreferredSize(new Dimension(40,40));
        ...
        a1.setPreferredSize(new Dimension(120,30));
        a2.setPreferredSize(new Dimension(120,30));
        a3.setPreferredSize(new Dimension(120,30));
        a4.setPreferredSize(new Dimension(120,30));
